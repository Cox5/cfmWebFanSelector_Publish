...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <table style="width: 700px">
        <tr><td colspan="2" align="left" class="tabletitle">Fan Locations</td><td colspan="4"><span id="projectName" runat="server"><asp:Label ID="lblProjectName" runat="server" Font-Bold="true"></asp:Label></span></td><td id="addFanCol" align="right" runat="server"><a href="<%= getAddFanLocationsURL() %>"><b>Add Fan Locations</b></a></td></tr>
        <tr>
